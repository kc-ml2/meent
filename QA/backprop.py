    ...
    def grad_numerical(ucell, delta):
        ...
        for r in range(ucell.shape[1]):
            for c in range(ucell.shape[2]):
                ...
                ucell_delta_m = ucell.at[0, r, c].set(ucell[0, r, c] - delta)
                ...
                ucell_delta_p = ucell.at[0, r, c].set(ucell[0, r, c] + delta)
                ...
                grad_arr[0, r, c] = grad_numeric

        return grad_arr

    print('grad_ad:', grad_loss(ucell))
    print('grad_numeric:', grad_numerical(ucell, 1E-5))
