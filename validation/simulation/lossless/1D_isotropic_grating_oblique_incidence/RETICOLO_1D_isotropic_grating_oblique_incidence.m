% Complex r/t amplitude coefficients and single-wavelength spatial fields for 1D_isotropic_grating_oblique_incidence.
%
...
for ip = 1:NP
    for id = 1:ND
        out_files{ip, id} = sprintf('RETICOLO_1D_isotropic_grating_oblique_incidence_%s_%s.txt', POLS{ip}, DIRS{id});
...
if RUN_FIELD_PROFILE
    ...
    reticolo_export_field('1D_isotropic_grating_oblique_incidence', FIELD_WAVELENGTH_M, period, textures, ...
