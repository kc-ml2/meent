function [R, T] = run_reticolo(_pol, theta, period, n_air, nn, _textures, _profile, wavelength)
...
k_parallel = n_air*sin(theta*pi/180); % n_air, or whatever the refractive index of the medium where light is coming in.
