...
from meent.on_numpy.convolution_matrix import to_conv_mat_piecewise_constant, find_nk_index
...
class JLABCode(RCWA):
    def __init__(self, grating_type=0, n_I=1.45, n_II=1., theta=0, phi=0, psi=0, fourier_order=40, period=100,
        ...
        super().__init__(0, grating_type, n_I, n_II, theta, phi, psi, fourier_order, period, wavelength, pol, patterns, ucell,
                         ucell_materials,
                         thickness, algo)
    ...
    def reproduce_acs_cell(self, n_ridge, n_groove):
        ...
        e_conv_all = to_conv_mat_piecewise_constant(self.ucell, self.fourier_order)
        o_e_conv_all = to_conv_mat_piecewise_constant(1 / self.ucell, self.fourier_order)
